...
|-----------------------|:--------:|-----------------------|--------------------------------------------------------|
| [MeadPoisonResist]@"Poison Resist" |  10 min  | Poison Very Resistant | Useful in Swamp. Situational in other biomes           | {biome:blackforest}
| [BarleyWine]@"Barley Wine"       |  10 min  | Fire Resistant        | Required with Root armor, Feather Cape, or in Ashlands | {biome:plains}
| [MeadFrostResist]@"Frost Resist"  |  10 min  | Frost Resistant       | Mountains without frost-resist gear                    | {biome:swamp}
| [MeadHealthMajor]@"Major Heal"    | 2 min CD | +125 HP over 10s      | Emergency heal in combat                               | {biome:mistlands}
| [MeadStaminaMedium]@"Medium Stam"   | 2 min CD | +160 Stamina instant  | Clutch stamina recovery mid-fight                      | {biome:plains}
| [MeadHasty]@"Ratatosk" |  10 min  | +15% speed            | Overland travel, speed runs                            | {biome:swamp}

### Situational Meads

| Mead                 | Duration | Effect                          | When to Use                              |
|----------------------|:--------:|---------------------------------|------------------------------------------|
| [MeadStaminaLingering]@"Lingering Stam"    |  5 min   | Stamina regen +25%              | Exploration, mining, woodcutting         | {biome:mistlands}
| [MeadEitrLingering]@"Lingering Eitr"      |  5 min   | Eitr regen +25%                 | Extended magic combat, boss fights                    | {biome:ashlands}
| [MeadLightfoot]@"Lightfoot"            |  10 min  | +20% jump, -30% jump stamina    | Mountain & Mistlands traversal           | {biome:mistlands}
| [MeadStrength]@"Troll Endurance"      |  5 min   | +250 carry weight (2 min CD)    | Ore runs, base building                  | {biome:swamp}
| [MeadSwimmer]@"Vananidir" |  5 min   | -50% swim stamina               | Ocean crossings without a boat           | {biome:swamp}
| [MeadBzerker]@"Berserkir"            |   20s    | -75% stam, physical weak (2 min CD) | Boss fights, DPS buff                    | {biome:plains}
...
| Biome | Best Picks |
|-------|-----------|
| <img src="/data/vh/BiomeMeadows.png" style="width:32px;height:32px;display:block"> Meadows | [CookedMeat]* **Cooked Meat** (HP) + [NeckTailGrilled]* **Grilled Neck Tail** (HP) + **Raspberries or Mushroom** (Stamina). Don't overcook boar meat and neck tails — raw versions are needed for later recipes. Cooked deer meat is fine to cook freely. | {biome:meadows}
...
| <img src="/data/vh/BiomeSwamp.png" style="width:32px;height:32px;display:block"> Swamp | [Sausages]* **Sausages** (HP 55/Stam 18) + [TurnipStew]* **Turnip Stew** (Stam 55/HP 18) + **Serpent Stew** (HP 80/Stam 26) if available. **Poison Resistance Mead** is encouraged. Start a turnip farm. Save serpent meat for boss fights if supply is low. | {biome:swamp}
| <img src="/data/vh/BiomeMountains.png" style="width:32px;height:32px;display:block"> Mountain | [WolfMeatSkewer]* **Wolf Skewer** (HP 65/Stam 21) + [OnionSoup]* **Onion Soup** (Stam 60/HP 20) + **Serpent Stew** or **Eyescream** (Stam 65/HP 21). Onion Soup doesn't need a high-tier cauldron — cook it before finding silver. Build a large onion farm. | {biome:mountain}
