...
You need a [Hammer]@ to get started. The game has an incredible build system with amazing auto snap points.
...
The workbench, like most workstations, can be upgraded with additional pieces. For example, collect [Flint]@, [LeatherScraps]@, and [DeerHide]@ to unlock a few workbench upgrades.

### Learn to block, parry, and dodge
...
Practice on Greylings and boars until parries are automatic. They hit for almost nothing, so mistakes are free. Boars charge on a long, obvious wind-up and are the best parry dummy in the game.
...
| Resource | Where | For |
|----------|-------|-----|
| [Wood]+ | Any tree. Birch and oak need a metal axe | Everything |
| [Stone]+ | Loose on the ground, or boulders | Fire, basic crafting |
| [Flint]+ | **Shorelines only** — lakes, rivers, sea | The whole first weapon tier |
| [LeatherScraps]+ [DeerHide]+ | Boars, deer | Workstation upgrades, weapons, armor, comfort |
| [RawMeat]+ [DeerMeat]+ | Boars, deer | Cooked food |
| [Honey]+ [QueenBee]+ | Beehives on abandoned houses | Best filler food, all meads |
...
| Creature | HP | Notes |
|----------|---:|-------|
| [TrophyNeck]@"Neck" | 5 | Weak. Only near the shores. {modbox:Fire:Weak} |
| [TrophyDeer]@"Deer" | 10 | Flees on sight. You need two trophies for the boss. Use spear. |
| [TrophyBoar]@"Boar" | 10 | Charges on a slow wind-up. Your parry tutor. Afraid of fire. |
| Greyling | 20 | Wanders in at night. Afraid of fire. {modbox:Fire:VeryWeak} |
...
You land from your Valkyrie flight here at the beginning of the game. You also respawn here if you haven't claimed a bed.

Each stone represents a Forsaken boss on your journey. Return boss trophies here and hang them up to unlock the Forsaken powers.

<img src="/img/guide/meadows/sacrificial-stones.webp" onerror="this.onerror=null;this.src='/img/guide/placeholder.svg'" alt="The full ring, with the empty Eikthyr head visible." style="width:100%;max-width:600px;border-radius:8px;display:block;margin:12px 0">

### Abandoned houses and farms

Ruined wooden buildings across the grassland. Always worth checking out:

* **Beehives** on the walls and eaves. Break one for [QueenBee]@ + [Honey]@. The queen lets you place your own hive at base — permanent honey, and the gateway to every mead. Grab every queen you see. Bees sting, so shoot the hive or just eat it.
* **Chests** with [Resin]@, [Feathers]@, [Coins]@, [ArrowFlint]@, [Amber]@, and [Flint]@.
* **Free lumber.** Park a workbench alongside and hammer the whole thing down.

<img src="/img/guide/meadows/beehive.webp" onerror="this.onerror=null;this.src='/img/guide/placeholder.svg'" alt="An abandoned house with a beehive clearly readable under the eaves." style="width:100%;max-width:600px;border-radius:8px;display:block;margin:12px 0">
...
* **Antler swipe** — short melee lunge. **Parry this.** It is the whole fight.
...
**Bow:** circle-strafe at range and never stop moving. The beam only fires where he faces, so a wide strafe makes it miss all day. Slower, near risk-free.

Do not get greedy at low Stamina.

<img src="/img/guide/meadows/eikthyr-fight.webp" onerror="this.onerror=null;this.src='/img/guide/placeholder.svg'" alt="Mid-fight, with the lightning beam or stomp AoE visible." style="width:100%;max-width:600px;border-radius:8px;display:block;margin:12px 0">
...
<img src="/img/guide/meadows/trophy-mounted.webp" onerror="this.onerror=null;this.src='/img/guide/placeholder.svg'" alt="The trophy hung on the boss stone, ideally with the activation glow." style="width:100%;max-width:600px;border-radius:8px;display:block;margin:12px 0">
