    ...
    <div className={`player-row ${playerStatus}`}>
      <div className="player-info">
        ...
        <div className="player-name">
          ...
          {mode === "logs" && player.stream.length > 5 && <div style={{fontSize:'smaller'}}><a href={player.stream} target="_blank"><Watch width="30" height="30" style={{ color:"#5b6eae", verticalAlign: "middle", margin:'0 0.7rem' }} />Watch</a></div>}
        </div>
