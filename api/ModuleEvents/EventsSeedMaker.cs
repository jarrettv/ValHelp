...
public class EventsSeedMaker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _logger.LogInformation($"{nameof(EventsSeedMaker)} is now making seeds");
        ...
        _logger.LogInformation($"{nameof(EventsSeedMaker)} is stopping");
    }
